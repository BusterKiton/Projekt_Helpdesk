...
from . import views
from .views import HelloWorld, RegisterView, LoginAPIView,UserTicketsApiView,WorkerTicketsApiView
...
urlpatterns = [
    ...
    path('api/worker/', WorkerTicketsApiView.as_view(), name='api-user'),
